SRC	=	ft_atoi.c ft_bzero.c ft_calloc.c ft_isascii.c ft_isalnum.c ft_isalpha.c ft_isdigit.c \
            ...
            ft_lstiteri.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c ft_memcpy.c ft_memmove.c \
            ft_memset.c ft_putchar_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_putstr_fd.c ft_split.c \
            ft_strchr.c ft_strcmp.c ft_strdup.c ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c \
